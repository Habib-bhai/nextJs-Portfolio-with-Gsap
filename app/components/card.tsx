...
function Card({src,h1, headingOne, headingTwo }:{src:string,h1:string, headingOne:string, headingTwo:string}) {
  return (
    ...
    <div  className="card sm:w-[500px] sm:h-[400px] sm:flex-shrink-0 hover:shadow-2xl shadow-2xl shadow-black hover:shadow-[#01f3a2] hover:transition-colors duration-1000 ease-in-out  rounded-2xl  mx-7 sm:mb-0 mb-12  ">
